...
from beit2._masking_generator import MaskingGenerator
from beit2._dataset_folder import ImageFolder
from data import *
...
def build_vqdk_dataset(istrain, args):
    pass


##########

def build_vqkd_dataset_(is_train, args):
    if is_train:
        t = []
